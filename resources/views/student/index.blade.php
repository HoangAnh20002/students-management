...
@section('content')
    ...
    <div id="page-wrapper">
        ...
        <div class="mt-3">
            <div class="search border bg-light shadow-sm py-2 px-2 rounded ml-4 mr-4">
                <form action="{{ route('student.index') }}" method="GET">
                    <div class="d-flex justify-content-around pl-5 py-2">
                        <div class="search_box">
                            <label for="result_from">Result From:</label>
                            <input type="number" step="any" id="result_from" class="form-control" name="result_from"
                                   min="0" max="10"
                                    ...
                                    <div>
                                        @if($student->course->count() < $student->department->last()->course->count())
                                            <form action="{{ route('student.send_email_notice') }}" method="POST">
                                                ...
                                                <button type="submit" class="btn bg-success ml-3 text-white">Notice
                                                </button>
                                            </form>
                                        @endif
                                    </div>
                                    <div>
                                        <form action="{{ route('result.show', ['result' => $student->id]) }}"
                                              method="GET">
                                            <input type="hidden" name="student_id" value="{{ $student->id }}">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h1 class="modal-title fs-5"
                                                        id="exampleModalLabel{{ $student->id }}">
